...
export default {
  ...
  title: {
    ...
    inbox: 'Posta — KUPOL',
    teamSanctions: 'Sanzioni — Pannello della squadra',
    teamUploads: 'File — Pannello della squadra',
    teamPetitions: 'Istanze — Pannello della squadra',
    userCard: 'Scheda utente — KUPOL',
    teamInbox: 'Messaggi — Pannello della squadra',
    ...
    teamSuggestions: 'Proposte — Pannello della squadra',
