...
export interface OutContainmentProcedure {
  title?: string;
  steps: OutRun[][];
}
export interface OutDirective {
  recipient: string;
  order: OutRun[];
  deadline?: string;
}
export interface OutTimelineEntry {
  time?: string;
  event: OutRun[];
}
export interface OutIncidentTimeline {
  entries: OutTimelineEntry[];
}
export interface OutPersonnelRecord {
  rank?: string;
  clearance?: string;
  status?: string;
}
export interface OutRosterEntry {
  name: string;
  position?: string;
}
export interface OutRoster {
  entries: OutRosterEntry[];
}
export interface OutHypothesis {
  text: OutRun[];
  result: OutRun[];
  confirmed?: boolean;
}
export interface OutQAEntry {
  question: OutRun[];
  answer: OutRun[];
}
export interface OutQA {
  entries: OutQAEntry[];
}
export interface OutRoutingEntry {
  who: string;
  decision: string;
}
...
export interface OutRouting {
  entries: OutRoutingEntry[];
}
 ...
 */
export interface CommentsBlockedError {
 ...
 */
export interface SecretCodeOut {
  id: number /* int64 */;
  code: string;
  document_ref: string;
  document_title: string;
  block_id?: string;
  reward_xp: number /* int */;
  note: string;
}
/**
