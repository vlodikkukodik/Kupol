...
export interface InvitationResponse {
  invitation: petitions.Invitation;
}
/**
 * InvitationsResponse — список приглашений.
 */
export interface InvitationsResponse {
  items: petitions.Invitation[];
}
/**
 ...
 */
export interface DecidePetitionRequest {
 ...
 * Коды ошибок API. Фронтенд ориентируется на code, а не на текст.
 */
export const CodeBanned = "banned"; // аккаунт заблокирован (шаг 5.9)
/**
 * Коды ошибок API. Фронтенд ориентируется на code, а не на текст.
 */
export const CodeCommentsBlocked = "comments_blocked"; // пометки временно запрещены (шаг 5.9)
/**
 * Коды ошибок API. Фронтенд ориентируется на code, а не на текст.
 */
export const CodeAlreadyRedeemed = "already_redeemed"; // скрытый код этим аккаунтом уже погашен
/**
 * Коды ошибок API. Фронтенд ориентируется на code, а не на текст.
 */
...
//////////
// source: team_secrets.go

export interface SecretCodesResponse {
  codes: documents.SecretCodeOut[];
}
export interface SecretCodeResponse {
  code: documents.SecretCodeOut;
}
