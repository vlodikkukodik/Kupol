...
const SAME_IN_BOTH = new Set([
  ...
  'databases.engine.mariadb',
  'databases.addrsPlaceholder',
  'mailhost.domainPlaceholder',
  'nav.dns',
  'activity.count',
  'support.categories.dns',
  'help.categories.dns',
  'dns.title',
  'dns.ttl',
  'dns.apex',
  'dns.domainPlaceholder',
  'mailhost.localPlaceholder',
  'mailhost.rules.forwardToPlaceholder',
  'cron.urlPlaceholder',
  'cms.locales.en_US',
  'runtime.kinds.php',
  'runtime.kinds.node',
  'runtime.kinds.python',
  'runtime.commandPlaceholderNode',
  'runtime.commandPlaceholderPython',
  ...
  'subdomains.placeholder',
  'siteSettings.indexPlaceholder',
  'siteSettings.hsts',
  'siteArea.ssl',
  'auth.forgot.email',
  'sites.cert.active',
