...
const KINDS: Record<string, () => string> = {
  ...
  'auth.totp_enable': () => t('activity.kinds.auth_totp_enable'),
  'auth.totp_disable': () => t('activity.kinds.auth_totp_disable'),
  ...
  'mail.domain_verify': () => t('activity.kinds.mail_domain_verify'),
  ...
  'dns.zone_verify': () => t('activity.kinds.dns_zone_verify'),
